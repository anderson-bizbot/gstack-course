...
> Sprint phase: **Other** | Template: 289 lines | Version: 1.0.0
...
**Step 4: Phase 0: Intake + Restore Point**

**Step 5: /autoplan Restore Point**
> Captured: [timestamp] | Branch: [branch] | Commit: [short hash]

**Step 6: Re-run Instructions**
> 1. Copy "Original Plan State" below back to your plan file

**Step 7: Original Plan State**
> [verbatim plan file contents]

**Step 8: Phase 1: CEO Review (Strategy & Scope)**
> Follow plan-ceo-review/SKILL.md — all sections, full depth.

**Step 9: Phase 2: Design Review (conditional — skip if no UI scope)**
> Follow plan-design-review/SKILL.md — all 7 dimensions, full depth.

**Step 10: Phase 3: Eng Review + Codex**
...
**Step 13: Phase 4: Final Approval Gate**
> **STOP here and present the final state to the user.**

**Step 14: /autoplan Review Complete**

**Step 15: Completion: Write Review Logs**
