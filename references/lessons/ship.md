...
> Sprint phase: **Ship** | Template: 656 lines | Version: 1.0.0
...
**Step 3: Step 2: Merge the base branch (BEFORE tests)**
> Fetch and merge the base branch into the feature branch so tests run against the merged state:

**Step 4: Step 2.5: Test Framework Bootstrap**
> {{TEST_BOOTSTRAP}}

**Step 5: Step 3: Run tests (on merged code)**
> **Do NOT run `RAILS_ENV=test bin/rails db:migrate`** — `bin/test-lane` already calls

**Step 6: Step 3.25: Eval Suites (conditional)**
